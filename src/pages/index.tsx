  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of healthcare with Doctor Appointment System v1 - Streamlining your medical consultations for a healthier tomorrow."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of healthcare with Doctor Appointment System v1 - Streamlining your medical consultations for a healthier tomorrow.`}
            </Text>
            <Box
